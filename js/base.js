 ...
 function update_task(index,data) {
   ...
   function render_task_detail(index) {
       ...
       var tpl =  '<form>'+
                  ...
                  '<lable>提醒时间</lable>'+
                  '<input class="datetime" name="remind_date" type="text" value="'+(item.remind_date ? item.remind_date:'')+'">'+
                  '</div>'+
       ...
       //选中其中的form元素  因为之后会使用其监听submit时间
  ...
  function add_task(new_task) {
    ...
    function delete_task(index) {
        if(task_list[index] === null){

        }
        //如果没有index或者index不存在则直接返回
        else if(index === undefined || !task_list[index]) return;
  ...
  function task_remind_check() {
     ...
     var itl = setInterval(function () {
          for(var i = 0; i < task_list.length; i++){
              ...
              // console.log(current_timestamp+'------'+task_timestamp+'------'+time_difference);
  ...
  function render_task_item(data,index) {
    ...
    var list_item_tpl =
        ...
        '<span class="float"><span class="action delete"> 删除</span>'+
